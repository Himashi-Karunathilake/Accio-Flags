<?php
    session_start();
    if(!($_SESSION["seshflg"] == 'fL@g_@Lbusperc1w@lWuLfR1cBRIANDumbled0Re')){
    ...
    $var1 = 'c8b6e3ef37961725f5694db6e7a254bd36ce5927a28fa953b72dd96addc77936';

    if ($var1 == $flag) { 
        echo "<script type='text/javascript'>alert('Correct!');document.location.href='level6.php'</script>";
                ...
                <div class="col-md-10">
                    ...
                    <div id="menu-container">
						...
						<div class="page-header">
                                <h2 style="text-align:left" class="page-title">Level 5</h2>
                            </div> <!-- /.page-header -->
                            <div class="row">
							...
							<div class="col-md-7">
							 <div class="content-inner">
                                        ...
                                        <p style="text-align:left">The 3rd Horcrux is Helga Hufflepuff's Cup. To destroy it, you need to <a href="teatime.php" target="_blank">find</a> it first. Submit the correct flag to discover The Cup.
