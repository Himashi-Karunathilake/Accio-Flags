<?php
    session_start();
    if(!($_SESSION["seshflg"] == 'ExpectoPatronus')){
    ...
    $var1 = 'MagicusExtremos';

			if ($var1 == $flag) { 
                echo "<script type='text/javascript'>alert('Correct!');document.location.href='level15.php'</script>";
                ...
                <div class="col-md-10">
                    ...
                    <div id="menu-container">
						...
						<div class="page-header">
                                <h2 style="text-align:left" class="page-title">Level 14</h2>
                            </div> <!-- /.page-header -->
                            <div class="row">
							...
							<div class="col-md-7">
							 <div class="content-inner">
                                        ...
                                        <p style="text-align:left">The 7th Horcrux is Nagini. You have succeeded in discovering it. Now, submit the correct flag to <a href="downloads/crackme2" download>destroy</a> Nagini.
