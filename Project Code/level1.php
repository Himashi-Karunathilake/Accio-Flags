<?php
    ...
    if ($var1 == $flag) { 
        echo "<script type='text/javascript'>alert('Correct!');document.location.href='level2.php'</script>";
        session_start();
						...
						<div class="page-header">
							...
							<div class="col-md-7">
							 <div class="content-inner">
                                        ...
                                        <p style="text-align:left">The 1st Horcrux is Tom Riddle's Diary. To destroy it, you need to find it first. Submit the correct flag to discover The Diary.
